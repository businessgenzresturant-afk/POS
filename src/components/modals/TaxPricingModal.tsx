      ...
      <div className="bg-background border border-border rounded-2xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-foreground">Tax & Pricing Settings</h2>
              <p className="text-xs text-muted-foreground mt-1">Configure tax rates and pricing rules</p>
            </div>
          </div>
          <button
            onClick={onClose}
